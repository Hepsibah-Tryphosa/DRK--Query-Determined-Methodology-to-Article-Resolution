            ...
            <div id="templatemo_sidebar">
                ...
                <div class="sidebar_box">
                    ...
                    <ul class="side_menu">
                        ...
                        <li><a href="request1.jsp"  class="style22"><strong>Request For Secret Key </strong></a></li>
            ...
            <div id="templatemo_content">
            	...
            	<div class="post_section"><span class="top"></span><span class="bottom"></span>
                  ...
                  <div class="post_content">
                        ...
                        <div>
						<form name="form1" method="post" action="request12.jsp">
...
%>
                ...
                </div><div class="post_section_bottom">
