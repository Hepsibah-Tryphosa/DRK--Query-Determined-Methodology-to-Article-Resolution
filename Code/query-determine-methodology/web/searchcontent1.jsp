            ...
            <div id="templatemo_sidebar">
                ...
                <div class="sidebar_box">
                    ...
                    <ul class="side_menu">
                        ...
                        <li><a href="searchc.jsp"  class="style22"><strong>Search on Content </strong></a></li>
            ...
            <div id="templatemo_content">
            	...
            	<div class="post_section"><span class="top"></span><span class="bottom"></span>
                  ...
                  <div style="margin 0 0 0 0; background: url(images/templatemo_post_header.jpg) top left no-repeat;">
                     	...
                     	<h2 align="center"><a href="#">K Nearest neighbors -- DOCUMENT DETAILS  </a></h2>
...
<table width="570" border="3" align="center" style="margin-top:50px;">
  ...
  <tr>
    <td><div align="left" class="style5 style1 style2"><span style="margin-left:20px;">Launched  Date and Time</span>(Year)</div></td>
    <td><%=s6%></td>
  </tr>
   <tr>
...
out.println("------------------------------------------------------------------------------------------------------------");
	...
	double unmatched_data=100.0000-matched_data;
		...
		st5.executeUpdate("insert into ratio(search_on,keyword,total,available ,matched_data,unmatched_data) values('Content','"+keyword+"','"+count+"','"+count1+"','"+matched_data+"','"+unmatched_data+"')" );
	
           connection.close();
		   
		   %>
		   		<p style="color:#99FF00; font-size:22px">In Preserving triple Search ratio for keyword : <%= keyword%> <br />  :&nbsp; <span style="color:#FFCC33;"><%= matched_data%>&nbsp; % </p>
				<p style="color:#99FF00; font-size:22px">Out preserving triple Searched data :<%=unmatched_data %> %</p>
		    <%
          }
