...
st.executeUpdate("insert into  author (aname,password,email,mobile,location,dob,address,gender,pincode,sk) values ('"+cname+"','"+pass+"','"+email+"','"+mobile+"','"+loca+"','"+dob+"','"+add+"','"+gen+"','"+pin+"','Rejected')");
