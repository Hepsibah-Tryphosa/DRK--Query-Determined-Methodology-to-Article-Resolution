...
<div id="templatemo_wrapper_outer">
            ...
            <div id="templatemo_content">
            	...
            	<div class="post_section"><span class="top"></span><span class="bottom"></span>
                  ...
                  <div class="post_content">
                     	...
                     	<h2><a href="#"><span class="style1">SEARCH DOCUMENT BASED ON CONTENT </span></a></h2>
                        
                        <form name="form1" method="post" action="searchcontent1.jsp">
  <p><%
  ...
  <table width="480" border="1" align="center">
    <tr>
      <td><span class="style2">Enter the Keyword to Search the Contents </span></td>
      <td><label>
