      	...
      	try 
	{
	  String query9="select * from document"; 
	   ...
	   count++;
           ...
           String query="select * from document where ddt LIKE '%"+keyword+"%'"; 
...
out.println("------------------------------------------------------------------------------------------------------------");
	...
	double unmatched_data=100.0000-matched_data;
		...
		st5.executeUpdate("insert into ratio(search_on,keyword,total,available ,matched_data,unmatched_data) values('Date','"+keyword+"','"+count+"','"+count1+"','"+matched_data+"','"+unmatched_data+"')" );
           connection.close();
          %>
