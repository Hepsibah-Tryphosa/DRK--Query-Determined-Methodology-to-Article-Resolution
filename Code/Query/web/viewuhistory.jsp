	...
	<div id="templatemo_wrapper_inner">
        ...
        <div id="templatemo_content_wrapper">
            ...
            <div id="templatemo_sidebar">
                ...
                <div class="sidebar_box">
                    ...
                    <ul class="side_menu">
						...
						<li><a href="viewuhistory.jsp"  class="style22"><strong>View MY Search History</strong> </a></li>
            ...
            <div id="templatemo_content">
			  ...
			  <h2><a href="#">WELCOME TO ADMIN MAIN PAGE </a></h2>
        		<iframe src="usersearchhistory.jsp" style="border:3px;" width="575" height="400"></iframe>
