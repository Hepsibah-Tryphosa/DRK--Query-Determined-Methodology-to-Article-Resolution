       	  ...
       	  <div class="post_box">
                ...
                <table  border="3"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse; display:inline; margin:10px 10px 10px 0px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px; width:560px;">
					<tr  style="color:#66CCCC;">
 						<td  width="80" valign="baseline" height="0" style="color: #2c83b0;"><div align="center"><b>Username</b></div></td>
					...
					<tr>
						...
						<td  width="80" valign="baseline" height="0" style="color:#FFFFFF;"align="center"><a href="generatekeyconfirm.jsp?mid=<%=i%>">waiting&nbsp;</a></td>
						<%
						}
						else
						{
						...
						%>
						<td  width="80" valign="baseline" height="0" style="color:#FFFFFF;"align="center"><a href="myprofile.jsp?mid=<%=i%>">more info..&nbsp;</a></td>
					</tr>
					<%
						}
						connection.close();
